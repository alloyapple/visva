...
{
	int residue =  [uiGridViewDelegate numberOfCellsOfGridView:self];
    residue = residue % [uiGridViewDelegate numberOfColumnsOfGridView:self];
...
- (IBAction) cellPressed:(id) sender
{
	...
	[uiGridViewDelegate gridView:self didSelect:cell];
}
