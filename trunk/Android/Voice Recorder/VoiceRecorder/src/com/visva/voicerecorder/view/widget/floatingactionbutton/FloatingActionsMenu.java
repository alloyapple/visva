package com.visva.voicerecorder.view.widget.floatingactionbutton;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonPlusColor = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonPlusIconColor, getColor(R.color.main));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        case EXPAND_RIGHT:
            ...
            int addButtonX = expandLeft ? r - l - mAddButton.getMeasuredWidth()
                    : 0;
            mAddButton.layout(addButtonX, 0,
            ...
            for (int i = mButtonsCount - 1; i >= 0; i--) {
                ...
                int childX = expandLeft ? nextX - child.getMeasuredWidth()
                        : nextX;
                int childY = (mAddButton.getMeasuredHeight() - child
                        .getMeasuredHeight()) / 2;
                child.layout(childX, childY, childX + child.getMeasuredWidth(),
                        childY + child.getMeasuredHeight());
