...
public class FragmentSaved extends FragmentBasic implements IClickUserAvatar {
    ...
    private void requestGetSaved(SessionLogin sessionLogin) {
        ...
        String url = BravoWebServiceConfig.URL_GET_SAVE_LIST.replace("{Spot_ID}", mSpotID);
        ...
        AsyncHttpGet getUserFollowing = new AsyncHttpGet(getActivity(), new AsyncHttpResponseProcess(getActivity(), this) {
            ...
            public void processIfResponseSuccess(String response) {
                ...
                mObGetUserSaved = gson.fromJson(response.toString(), ObGetUsersList.class);
                AIOLog.d("mObGetUserFollowing:" + mObGetUserSaved);
                if (mObGetUserSaved == null || mObGetUserSaved.data.size() == 0) {
                    return;
                }
                else {
                    mAdapterUserList.updateUserList(mObGetUserSaved.data);
                }
            }
