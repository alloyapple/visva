 ...
 * @author Lemon
 */
public class FAsyncHttpBase extends AsyncTask<String, Integer, String> {
	// Network status
	...
	protected FAsyncHttpResponseListener listener;
	 ...
	 * @param parameters
	 */
	public FAsyncHttpBase(Context context, FAsyncHttpResponseListener listener,
	...
	protected String doInBackground(String... args) {
		if (FNetworkUtility.getInstance(context).isNetworkAvailable()) {
