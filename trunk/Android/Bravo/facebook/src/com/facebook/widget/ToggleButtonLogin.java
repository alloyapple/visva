 ...
 */
public class ToggleButtonLogin extends ToggleButton {

    private static final String     TAG                  = ToggleButtonLogin.class.getName();
     ...
     */
    public ToggleButtonLogin(Context context) {
        super(context);
     ...
     */
    public ToggleButtonLogin(Context context, AttributeSet attrs, int defStyle) {
