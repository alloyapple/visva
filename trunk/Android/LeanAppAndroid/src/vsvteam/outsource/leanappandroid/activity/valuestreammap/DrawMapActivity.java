...
public class DrawMapActivity extends VSVTeamBaseActivity implements
	...
	public void onClick(View view) {
		if (view == btnExport) {
			Intent intentExport = new Intent(DrawMapActivity.this,
					ExportActivity.class);
			startActivity(intentExport);
		} else if (view == btnSetting) {
			Intent intentSetting = new Intent(DrawMapActivity.this,
					SettingActivity.class);
			startActivity(intentSetting);
			Log.e("click setting", "ok");
		} else if (view == btnVersion) {
			Intent intentVersion = new Intent(DrawMapActivity.this,
					VersionActivity.class);
			startActivity(intentVersion);
		} else if (view == btnChangedProject) {
			Intent intentChangeProject = new Intent(DrawMapActivity.this,
