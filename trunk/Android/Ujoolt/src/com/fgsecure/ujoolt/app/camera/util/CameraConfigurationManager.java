...
public final class CameraConfigurationManager {
	...
	public static final int TEN_DESIRED_ZOOM = 7; // 27
	 ...
	 */
	public void setDesiredCameraParameters(final Camera camera) {
	...
	public static boolean isZoomSupport(Camera camera) {
		Camera.Parameters parameters = camera.getParameters();
		String zoomSupportedString = parameters.get("zoom-supported");
		if (zoomSupportedString != null
				&& !Boolean.parseBoolean(zoomSupportedString)) {
			return Boolean.parseBoolean(zoomSupportedString);
		} else
			return false;
	}

	public static int getMaxZoomSupport(Camera camera) {
		Camera.Parameters parameters = camera.getParameters();
		String maxZoomString = parameters.get("max-zoom");
		// String maxZoomString = parameters.get("min-zoom");
	...
	public static boolean setZoom(Camera camera, int zoomLevel) {
		Camera.Parameters parameters = camera.getParameters();

		try {
			parameters.setZoom(zoomLevel / 10);
			return true;
		} catch (Exception e) {
