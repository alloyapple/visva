...
public class VideoViewActivity extends Activity implements OnClickListener, OnPreparedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.page_media_view);
		// init Button
		...
		Log.i("file Name", "file Name" + fileName);
	...
	public void onClick(View v) {
		...
		if (v == btnRetake) {
			Intent i = null;
			i = new Intent(VideoViewActivity.this, DgCamActivity.class);
	...
	private void scanSdCardVideo(String pathFile) {
		MyMediaConnectorClient client = new MyMediaConnectorClient(pathFile);
		MediaScannerConnection scanner = new MediaScannerConnection(VideoViewActivity.this, client);
