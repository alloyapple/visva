...
import com.fgsecure.ujoolt.app.camera.util.AutoFocusCallback;
import com.fgsecure.ujoolt.app.camera.util.CameraConfigurationManager;
...
public final class CameraManager {
	...
	public void openDriver(SurfaceHolder holder) throws IOException {
		...
		if (camera == null) {
			camera = Camera.open();
			if (camera == null) {
				Log.d("Camera", "null roi");
				throw new IOException();
			}
			Log.d("Cadkdjfhjgkghfkf", "" + camera);
		}
