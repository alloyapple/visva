...
public class PlaySoundManager {
	...
	static private PlaySoundManager _instance;
	 ...
	 */
	static synchronized public PlaySoundManager getInstance() {
		if (_instance == null)
			_instance = new PlaySoundManager();
		return _instance;
	}
	...
	public static void loadSounds(String filePath) {
		mSoundPoolMap.put(1, mSoundPool.load(filePath, 1));
	}
