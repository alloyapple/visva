package com.samsung.android.alwayssocial.database.prefs;
 ...
 * @author kieu.thang
 */
public class AlwaysSharePrefs {
    // ================================================================
    private Context context;

    public AlwaysSharePrefs(Context context) {
    ...
    public void putLongValue(String key, long n) {
        ...
        SharedPreferences pref = context.getSharedPreferences(GlobalConstant.ALWAYS_PREFERENCE, 0);
