package vn.zgome.game.streetknight.game.roma;
...
public class Nguadien extends ILive{
	...
	public Nguadien (GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void start () {
		...
		state = 1;
		xStartLeft=_screen.nvc.x + _screen.nvc.wiLeftAT + game.X(40) - game.X(200);
		xEndLeft =_screen.nvc.x+_screen.nvc.wi;
		xStartRight=_screen.nvc.x;
		xEndRight= _screen.nvc.x + _screen.nvc.wi - _screen.nvc.wiRightAT - game.X(40);
		if(isLeft)
		...
		deltaX = game.X(20);
		xStartAttackLeft = (int)(_screen.nvc.x+_screen.nvc.wi*_screen.nvc.legL+game.X(-200+20));
		xStartAttackRight =  (int)(_screen.nvc.x+_screen.nvc.wi*_screen.nvc.legR+game.X(-20));
	...
	public void draw () {
		...
		if(isFlip)
			...
			game.batcher.draw(Asset.ngua_dien.frames[ani.current].region, x, y, Asset.ngua_dien.frames[ani.current].wi, Asset.ngua_dien.frames[ani.current].hi);
	}
	public void drawFlip()
	{
		game.batcher.draw(Asset.ngua_dien.frames[ani.current].region.getTexture(),  x,y,Asset.ngua_dien.frames[ani.current].wi, Asset.ngua_dien.frames[ani.current].hi,Asset.ngua_dien.frames[ani.current].region.getRegionX() , Asset.ngua_dien.frames[ani.current].region.getRegionY(), Asset.ngua_dien.frames[ani.current].region.getRegionWidth(), Asset.ngua_dien.frames[ani.current].region.getRegionHeight(), true, false);
	}
	...
	{		
		...
		comment.set(x+Asset.ngua_dien.frames[0].wi/2 - Asset.comment.frames[0].wi/2, y+Asset.ngua_dien.frames[0].hi/2-Asset.comment.frames[0].hi/2,score);
