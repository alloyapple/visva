...
public class DauGauHN extends ILive{
	...
	int frameStartNor=0, frameEndNor=3, frameStartAttack=6, frameEndAttack=7, frameStartKick=4, frameEndKick=5;
	...
	public DauGauHN (GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void start () {		
		...
		state = 1;
		xStartLeft=_screen.nvc.x + _screen.nvc.wiLeftAT + game.X(125) - game.X(300);
		xEndLeft =_screen.nvc.x+_screen.nvc.wi;
		xStartRight=_screen.nvc.x;
		xEndRight= _screen.nvc.x + _screen.nvc.wi - _screen.nvc.wiRightAT - game.X(125);
		if(isLeft)
		...
		deltaX = game.X(20);
		xStartAttackLeft = _screen.nvc.x+_screen.nvc.wi/2+game.X(40-300);
		xStartAttackRight =  _screen.nvc.x+_screen.nvc.wi/2+game.X(-40);
	...
	public void draw () {
		...
		if(isFlip)
			...
			game.batcher.draw(Asset.dau_gau_ha_noi1.frames[ani.current].region, x, y, Asset.dau_gau_ha_noi1.frames[ani.current].wi, Asset.dau_gau_ha_noi1.frames[ani.current].hi);
	}
	public void drawFlip()
	{
		game.batcher.draw(Asset.dau_gau_ha_noi1.frames[ani.current].region.getTexture(),  x,y,Asset.dau_gau_ha_noi1.frames[ani.current].wi, Asset.dau_gau_ha_noi1.frames[ani.current].hi,Asset.dau_gau_ha_noi1.frames[ani.current].region.getRegionX() , Asset.dau_gau_ha_noi1.frames[ani.current].region.getRegionY(), Asset.dau_gau_ha_noi1.frames[ani.current].region.getRegionWidth(), Asset.dau_gau_ha_noi1.frames[ani.current].region.getRegionHeight(), true, false);
	}
	...
	{		
		...
		comment.set(x+Asset.dau_gau_ha_noi1.frames[0].wi/2 - Asset.comment.frames[0].wi/2, y+Asset.dau_gau_ha_noi1.frames[0].hi/2-Asset.comment.frames[0].hi/2,score);
