...
public class Daodua extends ILive
{
	int frame = 1;
	int x,y;
	int state;
	...
	public Daodua (GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void start () {
		...
		float xCPy;
		if(type == 1){
		x = (int)game.X(839-250*0.7f/2);
		y = (int)game.Y(490-200*0.7f/2);
		xCPy = ((float)((x+game.X(250*0.7f/2))-(_screen.nvc.x+_screen.nvc.xHead))/(float)((y+game.Y(200*0.7f/2))-(_screen.nvc.y+_screen.nvc.yHead)));
		deltaX=game.X(9);
		deltaY=(int)game.Y(9/xCPy);
		}
		else if(type==4)
		{
			x = (int)game.X(0-250*0.7f/2);
			y = (int)game.Y(490-200*0.7f/2);
			xCPy = ((float)(-(x+game.X(250*0.7f/2))+(_screen.nvc.x+_screen.nvc.xHead))/(float)((y+game.Y(200*0.7f/2))-(_screen.nvc.y+_screen.nvc.yHead)));
			deltaX=game.X(9);
			deltaY=(int)game.Y(9/xCPy);
		...
		xStartLeft = (int)(_screen.nvc.x-game.X(250*0.7f));
		...
		xStartAttackLeft = (int)(_screen.nvc.x + _screen.nvc.wi/2 + game.X((125-250)*0.7f));
	...
	public void draw () {
		// TODO Auto-generated method stub
		game.batcher.draw(Asset.dao_dua.frames[frame].region, x, y, Asset.dao_dua.frames[frame].wi*0.7f, Asset.dao_dua.frames[frame].hi*0.7f);
	...
	public void update (int delayTime) {
		...
		{
			if(type == 1 || type == 4){
				if((y>=yStartConner&&y<=yEndConner)||(type==4&&x>_screen.nvc.x + _screen.nvc.wi/2 - _screen.nvc.deltaConner +  Asset.dao_dua.frames[0].wi*0.7f/2)||(type==1&&x<=_screen.nvc.x + _screen.nvc.wi/2 +_screen.nvc.deltaConner -  Asset.dao_dua.frames[0].wi*0.7f/2))
			{				
				state = 2;
				ani.setInfo(frameStartKick, frameEndKick, timeFrameKick);
		...
		tick = 0;
		if(type == 1|| type == 4){
			if((y>=yStartAttackConner&&y<=yEndAttackConner)||((type==4&&(x>=_screen.nvc.x+_screen.nvc.wi/2-Asset.dao_dua.frames[0].wi*0.7f/2)||(type==1&&(x<=_screen.nvc.x+_screen.nvc.wi/2-Asset.dao_dua.frames[0].wi*0.7f/2)))))
		{	
			state = 2;
	...
	{
		x = (int)(x+Asset.dao_dua.frames[0].wi*0.7f/2);
		y = (int)(y+Asset.dao_dua.frames[0].hi*0.7f/2);
		
		x = (int)(x-Asset.dao_dua.frames[9].wi*0.7f/2);
		y = (int)(y-Asset.dao_dua.frames[9].hi*0.7f/2);
		
		xBlood3 = (int)(x + Asset.dao_dua.frames[9].wi*0.7f/2);
		yBlood3 = (int)(y + Asset.dao_dua.frames[9].hi*0.7f/2);
	...
	{		
		...
		comment.set(x+Asset.dao_dua.frames[0].wi*0.7f/2 - Asset.comment.frames[0].wi/2, y+Asset.dao_dua.frames[0].hi*0.7f/2-Asset.comment.frames[0].hi/2,score);
