...
public class DauGauAC2 extends ILive {
	...
	public DauGauAC2(GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void draw() {
		...
		if (isFlip)
			...
			game.batcher.draw(
					Asset.dau_gau_ai_cap_2.frames[ani.current].region, x, y,
					Asset.dau_gau_ai_cap_2.frames[ani.current].wi * 0.95f,
					Asset.dau_gau_ai_cap_2.frames[ani.current].hi * 0.95f);
	}

	public void drawFlip() {
		game.batcher.draw(Asset.dau_gau_ai_cap_2.frames[ani.current].region
				.getTexture(), x, y,
				Asset.dau_gau_ai_cap_2.frames[ani.current].wi * 0.95f,
				Asset.dau_gau_ai_cap_2.frames[ani.current].hi * 0.95f,
				Asset.dau_gau_ai_cap_2.frames[ani.current].region.getRegionX(),
				Asset.dau_gau_ai_cap_2.frames[ani.current].region.getRegionY(),
				Asset.dau_gau_ai_cap_2.frames[ani.current].region
						.getRegionWidth(),
				Asset.dau_gau_ai_cap_2.frames[ani.current].region
	...
	{		
		...
		comment.set(x+Asset.dau_gau_ai_cap_2.frames[0].wi/2 - Asset.comment.frames[0].wi/2, y+Asset.dau_gau_ai_cap_2.frames[0].hi/2-Asset.comment.frames[0].hi/2,score);
