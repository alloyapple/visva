...
public class DauGauDao extends ILive{
	...
	public DauGauDao (GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void draw () {
		...
		if(isFlip)
			...
			game.batcher.draw(Asset.dau_gau_dao_1.frames[ani.current].region, x, y, Asset.dau_gau_dao_1.frames[ani.current].wi, Asset.dau_gau_dao_1.frames[ani.current].hi);
	}
	public void drawFlip()
	{
		game.batcher.draw(Asset.dau_gau_dao_1.frames[ani.current].region.getTexture(),  x,y,Asset.dau_gau_dao_1.frames[ani.current].wi, Asset.dau_gau_dao_1.frames[ani.current].hi,Asset.dau_gau_dao_1.frames[ani.current].region.getRegionX() , Asset.dau_gau_dao_1.frames[ani.current].region.getRegionY(), Asset.dau_gau_dao_1.frames[ani.current].region.getRegionWidth(), Asset.dau_gau_dao_1.frames[ani.current].region.getRegionHeight(), true, false);
	}
	int tick;
	boolean isDrawEnd;
	int tickDraw;
	...
	{		
		...
		comment.set(x+Asset.dau_gau_dao_1.frames[0].wi/2 - Asset.comment.frames[0].wi/2, y+Asset.dau_gau_dao_1.frames[0].hi/2-Asset.comment.frames[0].hi/2,score);
