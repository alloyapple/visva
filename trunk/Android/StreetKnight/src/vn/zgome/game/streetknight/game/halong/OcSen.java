package vn.zgome.game.streetknight.game.halong;
...
public class OcSen extends ILive{
	...
	public OcSen (GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void start () {
		...
		state = 1;
		xStartLeft=_screen.nvc.x + _screen.nvc.wiLeftAT + game.X(50) - game.X(200);
		xEndLeft =_screen.nvc.x+_screen.nvc.wi;
		xStartRight=_screen.nvc.x;
		xEndRight= _screen.nvc.x + _screen.nvc.wi - _screen.nvc.wiRightAT - game.X(50);
	...
	public void draw () {
		...
		if(isFlip)
			...
			game.batcher.draw(Asset.oc_sen.frames[ani.current].region, x, y, Asset.oc_sen.frames[ani.current].wi, Asset.oc_sen.frames[ani.current].hi);
	}
	public void drawFlip()
	{
		game.batcher.draw(Asset.oc_sen.frames[ani.current].region.getTexture(),  x,y,Asset.oc_sen.frames[ani.current].wi, Asset.oc_sen.frames[ani.current].hi,Asset.oc_sen.frames[ani.current].region.getRegionX() , Asset.oc_sen.frames[ani.current].region.getRegionY(), Asset.oc_sen.frames[ani.current].region.getRegionWidth(), Asset.oc_sen.frames[ani.current].region.getRegionHeight(), true, false);
	}
	...
	{		
		...
		comment.set(x+Asset.oc_sen.frames[0].wi/2 - Asset.comment.frames[0].wi/2, y+Asset.oc_sen.frames[0].hi/2-Asset.comment.frames[0].hi/2,score);
