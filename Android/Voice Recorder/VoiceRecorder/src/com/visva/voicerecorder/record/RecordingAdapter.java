...
public class RecordingAdapter extends ArrayAdapter<RecordingSession> {
    ...
    public RecordingAdapter(Context context, int textViewResourceId, ArrayList<RecordingSession> objects) {
        super(context, textViewResourceId, objects);
        layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mRecordingManager = MyCallRecorderApplication.getInstance().getRecordManager(context, objects);
    }
