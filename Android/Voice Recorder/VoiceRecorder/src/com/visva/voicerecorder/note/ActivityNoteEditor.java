...
public class ActivityNoteEditor extends Activity implements IReminder {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_EDIT.equals(action)) {
            ...
            // For an insert or paste action:
                ...
                || MyCallRecorderConstant.MAKE_NOTE_INTENT.equals(action)) {
    ...
    protected void onPause() {
        ...
        if (mCursor != null) {
            ...
            if (isFinishing() && (length == 0)) {
                ...
                updateNote(text, null, mCreatedTime);
            } else if (mState == STATE_INSERT) {
                updateNote(text, text, mCreatedTime);
                mState = STATE_EDIT;
            }
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        //            //
        //            long timeToReminder = mDateByMiliSeconds + mTimeByMiliSeconds;
        //            Log.d("KieuThang", "timeToReminder:" + timeToReminder);
        //            ReminderProvider.getInstance(NoteEditor.this).addReminder(NoteEditor.class, NoteEditor.class.getName(), timeToReminder,
    ...
    public boolean onRemind(Context context, ReminderItem reminderItem) {
        ...
        Log.d("KieuThang", "reminderItem.className=>" + reminderItem.className);
        Log.d("KieuThang", "reminderItem.id=>" + reminderItem.id);
        Log.d("KieuThang", "reminderItem.intervalMillis=>" + reminderItem.intervalMillis);
        Log.d("KieuThang", "reminderItem.repeatCount=>" + reminderItem.repeatCount);
        Log.d("KieuThang", "reminderItem.triggerAtMillis=>" + reminderItem.triggerAtMillis);
        Intent intent = new Intent(context, ActivityReminder.class);
        intent.putExtra(MyCallRecorderConstant.EXTRA_CUSTOM_ID , reminderItem.id);
    ...
    public void onClickSaveNote(View v) {
        ...
        long timeToReminder = mDateByMiliSeconds + mTimeByMiliSeconds;
        Log.d("KieuThang", "timeToReminder:" + timeToReminder);
        ReminderProvider.getInstance(ActivityNoteEditor.this).addReminder(ActivityNoteEditor.class, String.valueOf(mCreatedTime), timeToReminder,
                AlarmManager.INTERVAL_DAY, 1);
        updateNote(text, null, mCreatedTime);
        finish();
    }
    ...
    final TimePickerDialog timePickerDialog12h = TimePickerDialog.newInstance(
                                                       new OnTimeSetListener() {
                                                           ...
                                                           public void onTimeSet(RadialPickerLayout view, int hourOfDay,
                                                               ...
                                                               mEditTextTime.setText(new StringBuilder().append(pad2(hourOfDay)).append(":")
    ...
    final TimePickerDialog timePickerDialog24h = TimePickerDialog.newInstance(
                                                       new OnTimeSetListener() {
                                                           ...
                                                           public void onTimeSet(RadialPickerLayout view, int hourOfDay,
                                                                   int minute) {
                                                               mTimeByMiliSeconds = hourOfDay * 60 * 60 * 1000 + minute * 60 * 1000;

                                                               mEditTextTime.setText(new StringBuilder().append(pad(hourOfDay)).append(":")
                                                                       .append(pad(minute)));
    ...
    final DatePickerDialog datePickerDialog    = DatePickerDialog.newInstance(
                                                       new OnDateSetListener() {
                                                           ...
                                                           public void onDateSet(DatePickerDialog datePickerDialog, int year, int month, int day) {
                                                               mEditTextDate.setText(new StringBuilder().append(pad(day)).append(" ")
