...
public class TCycleTimeDataBaseHandler extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_T_CYCLETIME + " ("
				+ KEY_CYCLETIME_ID + " INTEGER PRIMARY KEY," + KEY_PROCESS_ID + " INTEGER,"
				+ KEY_PROJECT_ID + " INTEGER," + KEY_PROCESS_NAME + " TEXT," + KEY_PROJECT_NAME
				+ " TEXT," + KEY_CYCLE_COUNTER + " INTEGER," + KEY_OPERATOR + " TEXT,"
				+ KEY_SHIFT_NO + " INTEGER," + KEY_STEP_ID + " INTEGER," + KEY_STEP_DESCRIPTION
				+ " TEXT," + KEY_LOWEST_TIME + " TEXT," + KEY_ADJUSTMENT + " TEXT,"
				+ KEY_ADJUSTED_TIME + " TEXT," + KEY_AUDIO_NOTE + " TEXT," + KEY_VIDEO_FILE_NAME
				+ " TEXT," + KEY_START_TIME_STAMP + " TEXT," + KEY_END_TIME_STAMP + " TEXT,"
				+ KEY_VERSION_ID + " INTEGER," + KEY_PREVIOUS_VERS_ID + " INTEGER,"
	...
	public void addNewCycleTime(TCycleTimeDataBase cycleTime) {
		...
		// operator
		values.put(KEY_OPERATOR, cycleTime.getOperator());
		// shift no
		...
		values.put(KEY_PRE_VERS_DIFFERENCE_LOWEST_TIME, cycleTime.getPreVerDifferenceLowestTime());
		...
		// next cycleTime
		values.put(KEY_PRE_VERS_DIFFERENCE_ADJUSTMENT, cycleTime.getPreVerDifferenceAdjustment());
	...
	public List<TCycleTimeDataBase> getAllCycleTime(int processId) {
		...
		Cursor cursor = db.query(TABLE_T_CYCLETIME, new String[] { KEY_CYCLETIME_ID,
				KEY_PROCESS_ID, KEY_PROJECT_ID, KEY_PROCESS_NAME, KEY_PROJECT_NAME,
				KEY_CYCLE_COUNTER, KEY_OPERATOR, KEY_SHIFT_NO, KEY_STEP_ID, KEY_STEP_DESCRIPTION,
				KEY_LOWEST_TIME, KEY_ADJUSTMENT, KEY_ADJUSTED_TIME, KEY_AUDIO_NOTE,
				KEY_VIDEO_FILE_NAME, KEY_START_TIME_STAMP, KEY_END_TIME_STAMP, KEY_VERSION_ID,
				KEY_PREVIOUS_VERS_ID, KEY_PRE_VERS_DIFFERENCE_LOWEST_TIME,
				KEY_PRE_VERS_DIFFERENCE_ADJUSTED_TIME, KEY_PRE_VERS_DIFFERENCE_ADJUSTMENT },
		...
		if (cursor.moveToFirst()) {
			do {
				...
				cycleTime.setCycleCounter(Integer.parseInt(cursor.getString(5)));
				cycleTime.setOperator(cursor.getString(6));
				...
				cycleTime.setPreviousVersionId(Integer.parseInt(cursor.getString(18)));
