...
public class CircleTimeActivity extends VSVTeamBaseActivity implements OnClickListener {
	//==============================Control Define =========================
	...
	public void onClick(View v) {
		if (v == imgStartRecording) {
//			Intent intent = new Intent(CircleTimeActivity.this, CircleTimeRecordingActivity.class);
//			startActivity(intent);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		imgStartRecording = (ImageView) findViewById(R.id.img_circle_timing_record_video);
		imgStartRecording.setOnClickListener(this);
