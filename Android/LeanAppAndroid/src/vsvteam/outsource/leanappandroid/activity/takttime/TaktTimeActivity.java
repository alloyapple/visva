...
public class TaktTimeActivity extends VSVTeamBaseActivity implements OnClickListener {
	...
	public void onClick(View view) {
		if (view == btnExport) {
			gotoActivityInGroup(TaktTimeActivity.this, ExportActivity.class);
		} else if (view == btnSetting) {
			gotoActivityInGroup(TaktTimeActivity.this, SettingActivity.class);
			Log.e("click setting", "ok");
		} else if (view == btnVersion) {
			gotoActivityInGroup(TaktTimeActivity.this, VersionActivity.class);
		} else if (view == btnChangedProject) {
			gotoActivityInGroup(TaktTimeActivity.this, ChangeProjectActivity.class);
