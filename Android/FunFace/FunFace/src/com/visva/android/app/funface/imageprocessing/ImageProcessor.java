...
public class ImageProcessor {
    ...
    /**
     * Make bitmap to gamma.Gamma correction or gamma encoding is one among the common image processing method.
     * @param src
     * @param red
     * @param green
     * @param blue
    ...
    /**
     * Image Processing – Contrast Image On The Fly
     * 
     * @param src
     * @param value
     * @return
     ...
     *{@code} + By increasing: image results brighter.
