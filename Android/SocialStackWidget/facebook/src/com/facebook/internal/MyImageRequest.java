...
public class MyImageRequest {
    ...
    public interface Callback {
         ...
         * @param response
         */
        void onCompleted(MyImageResponse response);
    }
...
//        Validate.notNullOrEmpty(imageUrl, "userId");
    	Log.d("getProfilePictureUrl", "ImageURL "+imageUrl);
        ...
        Uri.Builder builder = new Uri.Builder().encodedPath(String.format(imageUrl));
    ...
    private MyImageRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public MyImageRequest build() {
            return new MyImageRequest(this);
        }
    }
}
