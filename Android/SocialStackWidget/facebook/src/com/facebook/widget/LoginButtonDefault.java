 ...
 */
public class LoginButtonDefault extends Button {

	private static final String TAG = LoginButtonDefault.class.getName();
	 ...
	 */
	public LoginButtonDefault(Context context) {
		super(context);
	 ...
	 */
	public LoginButtonDefault(Context context, AttributeSet attrs, int defStyle) {
	...
	public void onClickFacebookLogoutButton() {
