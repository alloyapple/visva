package com.fgsecure.ujoolt.app.widget.imagezoom;
...
public class ImageViewTouch extends ImageViewTouchBase {
	...
	public float firstX, firstY, lastX, lastY;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			if (firstX == lastX && firstY == lastY) {
				mainScreenActivity.isShowAvatar = false;
				mainScreenActivity.isBubbleDetail = true;
				mainScreenActivity.layoutShowAvatar.setVisibility(View.INVISIBLE);
			} else {
				if (getScale() < 1f) {
					zoomTo(1f, 50);
				}
