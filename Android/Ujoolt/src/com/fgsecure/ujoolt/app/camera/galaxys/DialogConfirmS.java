...
public class DialogConfirmS extends Activity {
	...
	private void openDialogChoseFile() {
		...
		builder1.setOnCancelListener(new DialogInterface.OnCancelListener() {
			...
			public void onCancel(DialogInterface dialog) {
				Intent i = new Intent(DialogConfirmS.this, DgCamActivityS.class);
		...
		builder1.setItems(items, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int item) {
				...
				if ("Image".equals(items[item])) {
					...
					Intent intent = new Intent(DialogConfirmS.this,ImageViewActivityS.class);					
					isPhoto = true;
					...
					Intent intent = new Intent(DialogConfirmS.this,
							MediaViewGalleryS.class);
					isPhoto = false;
					intent.putExtra("isPhoto", isPhoto);
					startActivity(intent);
					finish();
