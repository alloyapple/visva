...
public class MediaViewGalleryS extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.page_camera_view_gallery_s);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode == RESULT_OK) {
			...
			Intent i = new Intent(MediaViewGalleryS.this, DgCamActivityS.class);
	...
	private void controlVideoRecording() {
		isGetFile = true;
		MediaController mc = new MediaController(MediaViewGalleryS.this);
	...
	private void showDialogVideoOutOfTime() {
		...
		builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				Intent i = null;
				i = new Intent(MediaViewGalleryS.this, DgCamActivityS.class);
				i.putExtra("isPhoto", false);
				startActivity(i);
				isGetFile = false;
