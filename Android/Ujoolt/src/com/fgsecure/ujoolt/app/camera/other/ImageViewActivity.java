...
public class ImageViewActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.page_image_view_gallery);
		// init
		isGetImg = false;
		if (frameLayout == null)
			frameLayout = (FrameLayout) findViewById(R.id.camera_preview1);
		if (btnRetake == null)
		...
		if (btnClose == null)
			btnClose = (Button) findViewById(R.id.close_camera1);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode == RESULT_OK) {
			if (requestCode == SELECT_PICTURE) {
				...
				Log.e("Lemon-ImageViewActivity", "Path in main screen : "
						+ MainScreenActivity.myPath);
				if (selectedImagePath != null) {
					imgView.setImageBitmap(resizeImage(selectedImagePath, null, 400, 600));
				} else {
					Intent i = new Intent(ImageViewActivity.this, DgCamActivity.class);
	...
	public void onClick(View v) {
		...
		if (v == btnUse) {
			Log.e("Cane:use this pic", "use this pic ok");
			...
			mat.preRotate(90);
			Bitmap bitmap = Bitmap.createBitmap(avatar, 0, 0, avatar.getWidth(),
					avatar.getHeight(), mat, true);
			MainScreenActivity.bitmapJoltAvatar = bitmap;
			MainScreenActivity.btnUploadPhoto.setBackgroundDrawable(new BitmapDrawable(bitmap));
			// MainScreenActivity.bm_jolt_avatar = avatar;
			...
			Log.e("Lemon-ImageViewActivity", "Path in main screen after Use click : "
					+ MainScreenActivity.myPath);
			if (imgView != null) {
				imgView = null;
			}
