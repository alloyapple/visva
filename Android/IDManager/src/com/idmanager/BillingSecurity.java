...
import com.idmanager.C.PurchaseState;
import com.idmanager.util.Base64;
import com.idmanager.util.Base64DecoderException;
...
public class BillingSecurity {
	...
	public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData,
		...
		if (!TextUtils.isEmpty(signature)) {
			 ...
			 */
			String base64EncodedPublicKey = KEY_APP;
