...
public class GGTestDownloadController extends AsyncTask<Void, Long, Integer> {
	...
	public GGTestDownloadController(Activity context, Drive service, java.io.File fileDb,
