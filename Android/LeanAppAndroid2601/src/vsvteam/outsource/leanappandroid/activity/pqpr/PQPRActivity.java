package vsvteam.outsource.leanappandroid.activity.pqpr;
...
public class PQPRActivity extends VSVTeamBaseActivity implements
		OnClickListener {
	private ListView mListViewPQPR;
	...
	public void onClick(View v) {
		...
		if (v==btnExport) {
			gotoActivityInGroup(PQPRActivity.this,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.page_menu_bar_pqpr);
		mListViewPQPR = (ListView) findViewById(R.id.id_listview_pqpr);
		mListViewPQPR.setAdapter(new ListPQPRAdapter(this));
		((FrameLayout) findViewById(R.id.id_frame_chart_in_pqpr_1))
				.addView(addCombineChartView(new int[] { 1, 2, 3, 4, 5 },
						new double[] { 10, 20, 30, 40, 50 }, new double[] { 10,
								20, 38, 21, 50 }));
		((FrameLayout) findViewById(R.id.id_frame_chart_in_pqpr_2))
				.addView(addCombineChartView(new int[] { 1, 2, 3, 4, 5 },
						new double[] { 10, 20, 30, 40, 50 }, new double[] { 10,
								20, 38, 21, 50 }));
	...
	class ListPQPRAdapter extends BaseAdapter {

		private Context mContext;

		public ListPQPRAdapter(Context pContext) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			v = mInflater.inflate(R.layout.item_list_pqpr, null);
			return v;
		}
