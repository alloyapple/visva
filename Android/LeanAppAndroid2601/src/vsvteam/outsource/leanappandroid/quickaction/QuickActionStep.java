package vsvteam.outsource.leanappandroid.quickaction;
...
public class QuickActionStep extends PopupWindows {
	...
	public QuickActionStep(Context context) {
		super(context);
		...
		setRootViewId(R.layout.quickaction_step);
	...
	public void show(View anchor, boolean isListProcess) {
		preShow();
