...
public class IdPasswordItem {
	...
	public IdPasswordItem(int passWordId, int folderId, String titleRecord, String icon,
			...
			String timeStamp, boolean isEncrypted, int userId) {
		super();
	...
	public IdPasswordItem(Context context, IdPasswordItem id) {
		super();
		this.passWordId = id.passWordId;
		this.folderId = id.folderId;
		this.titleRecord = id.titleRecord;
		this.icon = id.icon;
		this.favouriteGroup = id.favouriteGroup;
		this.titleId1 = id.titleId1;
		this.dataId1 = id.dataId1;
		this.titleId2 = id.titleId2;
		this.dataId2 = id.dataId2;
		this.titleId3 = id.titleId3;
		this.dataId3 = id.dataId3;
		this.titleId4 = id.titleId4;
		this.dataId4 = id.dataId4;
		this.titleId5 = id.titleId5;
		this.dataId5 = id.dataId5;
		this.titleId6 = id.titleId6;
		this.dataId6 = id.dataId6;
		this.titleId7 = id.titleId7;
		this.dataId7 = id.dataId7;
		this.titleId8 = id.titleId8;
		this.dataId8 = id.dataId8;
		this.titleId9 = id.titleId9;
		this.dataId9 = id.dataId9;
		this.titleId10 = id.titleId10;
		this.dataId10 = id.dataId10;
		this.titleId11 = id.titleId11;
		this.dataId11 = id.dataId11;
		this.titleId12 = id.titleId12;
		this.dataId12 = id.dataId12;
		this.url = id.url;
		this.note = id.note;
		this.imageMemo = id.imageMemo;
		this.flag = id.flag;
		this.timeStamp = id.timeStamp;
		this.isEncrypted = id.isEncrypted;
