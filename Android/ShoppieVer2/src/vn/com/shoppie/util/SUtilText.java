...
public class SUtilText {
	public static void setFontDigital(Context ctx,TextView tv){
		tv.setTypeface(getDigital(ctx));
	}
	public static void setFontRoboto(Context ctx,TextView tv){
		tv.setTypeface(getRoboto(ctx));
	}
	public static Typeface getDigital(Context ctx){
	 ...
	 * */
	public static Typeface getFont(Context ctx, String pathFont) {
