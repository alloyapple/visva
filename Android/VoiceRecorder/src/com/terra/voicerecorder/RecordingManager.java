...
public class RecordingManager extends Object implements OnPreparedListener,OnCompletionListener{
	...
	private MediaPlayer preSoundPlayer;
	private MediaPlayer postSoundPlayer;
	...
	public RecordingManager(Context _context,ArrayList<RecordingSession> sessions){
		...
		this.preSoundPlayer = MediaPlayer.create(context, R.raw.beep_start);
		this.postSoundPlayer = MediaPlayer.create(context, R.raw.beep_end);
		
		this.preSoundPlayer.setOnCompletionListener(new OnCompletionListener() {
