package com.sharebravo.bravo.sdk.util.location.svc;
...
import com.sharebravo.bravo.sdk.provider.LocationProvider;
...
public class LocationRequestManager {
    ...
    public void updateCurrentLocation(final Context context, int type) {
        ...
        mILocationChangedCallback = new ILocationChangedCallback() {
            ...
            public void onLocationChanged(Location location) {
                ...
                LocationProvider.getInstance(context).getHandler().sendEmptyMessage(BravoConstant.MSG_UPDATE_LOCATION);
            }
        };
    ...
    public void registerUpdateLocation(int type) {
        ...
        if (type == BravoConstant.GET_LOCATION_TYPE_GOOGLE_SERVICE) {
        ...
        } else if ((type == BravoConstant.GET_LOCATION_TYPE_GPS)) {
            addGPSListener();
        } else if (type == BravoConstant.GET_LOCATION_TYPE_NETWORK) {
            addNetworkListener();
        }
    }
