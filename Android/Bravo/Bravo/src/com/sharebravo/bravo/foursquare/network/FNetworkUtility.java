 ...
 * @author Lemon
 */
public final class FNetworkUtility {
	private Context context = null;

	private static FNetworkUtility instance = null;
	 ...
	 * @param context
	 */
	private FNetworkUtility(Context context) {
	 ...
	 * @return
	 */
	public static FNetworkUtility getInstance(Context context) {
		if (instance == null) {
			instance = new FNetworkUtility(context);
		}
		return instance;
	}
