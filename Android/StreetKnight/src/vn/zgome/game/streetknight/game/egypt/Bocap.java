...
public class Bocap extends ILive{
	...
	int frameStartNor=0, frameEndNor=4, frameStartAttack=5, frameEndAttack=6, frameStartKick=7, frameEndKick=8;
	...
	public Bocap (GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void start () {
		...
		state = 1;
		xStartLeft=(int)(_screen.nvc.x + _screen.nvc.wiLeftAT + game.X((75 - 300)*0.6f));
		xEndLeft =_screen.nvc.x+_screen.nvc.wi;
		xStartRight=_screen.nvc.x;
		xEndRight= (int)(_screen.nvc.x + _screen.nvc.wi - _screen.nvc.wiRightAT - game.X(75*0.6f));
		if(isLeft)
		...
		deltaX = game.X(20);
		xStartAttackLeft = (int)(_screen.nvc.x+_screen.nvc.wi*_screen.nvc.legL+game.X((-300+75)*0.6f));
		xStartAttackRight =  (int)(_screen.nvc.x+_screen.nvc.wi*_screen.nvc.legR+game.X(-75*0.6f));
	...
	public void draw () {
		...
		if(isFlip)
			...
			game.batcher.draw(Asset.bo_cap.frames[ani.current].region, x, y, Asset.bo_cap.frames[ani.current].wi*0.6f, Asset.bo_cap.frames[ani.current].hi*0.6f);
	}
	public void drawFlip()
	{
		game.batcher.draw(Asset.bo_cap.frames[ani.current].region.getTexture(),  x,y,Asset.bo_cap.frames[ani.current].wi*0.6f, Asset.bo_cap.frames[ani.current].hi*0.6f,Asset.bo_cap.frames[ani.current].region.getRegionX() , Asset.bo_cap.frames[ani.current].region.getRegionY(), Asset.bo_cap.frames[ani.current].region.getRegionWidth(), Asset.bo_cap.frames[ani.current].region.getRegionHeight(), true, false);
	}
	...
	{		
		...
		comment.set(x+Asset.bo_cap.frames[0].wi*0.6f/2 - Asset.comment.frames[0].wi/2, y+Asset.bo_cap.frames[0].hi*0.6f/2-Asset.comment.frames[0].hi/2,score);
