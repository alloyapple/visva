...
public class Meo extends ILive{
	...
	int frameStartNor=0, frameEndNor=1, frameStartAttack=2, frameEndAttack=3, frameStartKick=5, frameEndKick=6;
	...
	public Meo (GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void start () {
		...
		deltaX = game.X(20);
		xStartAttackLeft = (int)(_screen.nvc.x+_screen.nvc.wi*_screen.nvc.legL+game.X(-250+20));
	...
	public void draw () {
		...
		if(isFlip)
			...
			game.batcher.draw(Asset.meo.frames[ani.current].region, x, y, Asset.meo.frames[ani.current].wi, Asset.meo.frames[ani.current].hi);
	}
	public void drawFlip()
	{
		game.batcher.draw(Asset.meo.frames[ani.current].region.getTexture(),  x,y,Asset.meo.frames[ani.current].wi, Asset.meo.frames[ani.current].hi,Asset.meo.frames[ani.current].region.getRegionX() , Asset.meo.frames[ani.current].region.getRegionY(), Asset.meo.frames[ani.current].region.getRegionWidth(), Asset.meo.frames[ani.current].region.getRegionHeight(), true, false);
	}
	...
	{		
		...
		comment.set(x+Asset.meo.frames[0].wi/2 - Asset.comment.frames[0].wi/2, y+Asset.meo.frames[0].hi/2-Asset.comment.frames[0].hi/2,score);
