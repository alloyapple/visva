...
public class DauGauAC extends ILive {
	...
	{		
		...
		comment.set(x+Asset.dau_gau_ai_cap_1.frames[0].wi/2 - Asset.comment.frames[0].wi/2, y+Asset.dau_gau_ai_cap_2.frames[0].hi/2-Asset.comment.frames[0].hi/2,score);
