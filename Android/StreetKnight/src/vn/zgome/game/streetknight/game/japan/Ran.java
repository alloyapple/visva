...
public class Ran extends ILive{
	...
	int frameStartNor=0, frameEndNor=5, frameStartAttack=6, frameEndAttack=7, frameStartKick=8, frameEndKick=9;
	...
	public Ran (GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void start () {
		...
		state = 1;
		xStartLeft=_screen.nvc.x + _screen.nvc.wiLeftAT + game.X(90) - game.X(200);
		xEndLeft =_screen.nvc.x+_screen.nvc.wi;
		xStartRight=_screen.nvc.x;
		xEndRight= _screen.nvc.x + _screen.nvc.wi - _screen.nvc.wiRightAT - game.X(90);
		if(isLeft)
		...
		deltaX = game.X(20);
		xStartAttackLeft = (int)(_screen.nvc.x+_screen.nvc.wi*_screen.nvc.legL+game.X(-200+40));
		xStartAttackRight =  (int)(_screen.nvc.x+_screen.nvc.wi*_screen.nvc.legR+game.X(-40));
	...
	public void draw () {
		...
		if(isFlip)
			...
			game.batcher.draw(Asset.ran.frames[ani.current].region, x, y, Asset.ran.frames[ani.current].wi, Asset.ran.frames[ani.current].hi);
	}
	public void drawFlip()
	{
		game.batcher.draw(Asset.ran.frames[ani.current].region.getTexture(),  x,y,Asset.ran.frames[ani.current].wi, Asset.ran.frames[ani.current].hi,Asset.ran.frames[ani.current].region.getRegionX() , Asset.ran.frames[ani.current].region.getRegionY(), Asset.ran.frames[ani.current].region.getRegionWidth(), Asset.ran.frames[ani.current].region.getRegionHeight(), true, false);
	}
	...
	{		
		...
		comment.set(x+Asset.ran.frames[0].wi/2 - Asset.comment.frames[0].wi/2, y+Asset.ran.frames[0].hi/2-Asset.comment.frames[0].hi/2,score);
