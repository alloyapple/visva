...
public class DauGauJP2 extends ILive {
	...
	int timeFrameNor = ILive.TIME_STEP_AND_FPS_ANIMAL, timeFrameAttack = 800, timeFrameKick = 200,
			timeWaitKick = 1000;
	...
	public DauGauJP2(GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void start() {
		...
		y = game.Y(60);
		state = 1;
		xStartLeft = _screen.nvc.x + _screen.nvc.wiLeftAT + game.X(100)
				- game.X(300);
		xEndLeft = _screen.nvc.x + _screen.nvc.wi;
		xStartRight = _screen.nvc.x;
		xEndRight = _screen.nvc.x + _screen.nvc.wi - _screen.nvc.wiRightAT
				- game.X(100);
		if (isLeft)
		...
		deltaX = game.X(20);
		xStartAttackLeft = _screen.nvc.x + _screen.nvc.wi / 2 + game.X(-300);
		xStartAttackRight = _screen.nvc.x + _screen.nvc.wi / 2 + game.X(0);
	...
	public void draw() {
		...
		if (isFlip)
			...
			game.batcher.draw(Asset.dau_gau_nhat_2.frames[ani.current].region,
					x, y, Asset.dau_gau_nhat_2.frames[ani.current].wi,
					Asset.dau_gau_nhat_2.frames[ani.current].hi);
	}

	public void drawFlip() {
		game.batcher.draw(Asset.dau_gau_nhat_2.frames[ani.current].region
				.getTexture(), x, y,
				Asset.dau_gau_nhat_2.frames[ani.current].wi,
				Asset.dau_gau_nhat_2.frames[ani.current].hi,
				Asset.dau_gau_nhat_2.frames[ani.current].region.getRegionX(),
				Asset.dau_gau_nhat_2.frames[ani.current].region.getRegionY(),
				Asset.dau_gau_nhat_2.frames[ani.current].region
						.getRegionWidth(),
				Asset.dau_gau_nhat_2.frames[ani.current].region
	...
	{		
		...
		comment.set(x+Asset.dau_gau_nhat_2.frames[0].wi/2 - Asset.comment.frames[0].wi/2, y+Asset.dau_gau_nhat_2.frames[0].hi/2-Asset.comment.frames[0].hi/2,score);
