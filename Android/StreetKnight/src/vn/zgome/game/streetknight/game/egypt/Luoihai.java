...
public class Luoihai extends ILive
{
	int frame = 1;
	int x,y;
	int state;
	...
	public Luoihai (GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void draw () {
		// TODO Auto-generated method stub
		game.batcher.draw(Asset.luoi_hai.frames[frame].region, x, y, Asset.luoi_hai.frames[frame].wi*0.6f, Asset.luoi_hai.frames[frame].hi*0.6f);
		if(state == 2)
		{
	...
	public void update (int delayTime) {
		...
		{
			if(type == 1 || type == 4){
				if((y>=yStartConner&&y<=yEndConner)||(type==4&&x>_screen.nvc.x + _screen.nvc.wi/2 - _screen.nvc.deltaConner +  Asset.luoi_hai.frames[0].wi*0.6f/2)||(type==1&&x<=_screen.nvc.x + _screen.nvc.wi/2 +_screen.nvc.deltaConner -  Asset.luoi_hai.frames[0].wi*0.6f/2))
			{				
				state = 2;
				ani.setInfo(frameStartKick, frameEndKick, timeFrameKick);
		...
		tick = 0;
		if(type == 1|| type == 4){
		if((y>=yStartAttackConner&&y<=yEndAttackConner)||((type==4&&(x>=_screen.nvc.x+_screen.nvc.wi/2-Asset.luoi_hai.frames[0].wi*0.6f/2)||(type==1&&(x<=_screen.nvc.x+_screen.nvc.wi/2-Asset.luoi_hai.frames[0].wi*0.6f/2)))))
		{	
			state = 2;
	...
	{
		x = (int)(x+Asset.luoi_hai.frames[0].wi*0.6f/2);
		y = (int)(y+Asset.luoi_hai.frames[0].hi*0.6f/2);
		
		x = (int)(x-Asset.luoi_hai.frames[9].wi*0.6f/2);
		y = (int)(y-Asset.luoi_hai.frames[9].hi*0.6f/2);
		
		xBlood3 = (int)(x + Asset.luoi_hai.frames[9].wi*0.6f/2);
		yBlood3 = (int)(y + Asset.luoi_hai.frames[9].wi*0.6f/2);
	...
	{		
		...
		comment.set(x+Asset.luoi_hai.frames[0].wi*0.6f/2 - Asset.comment.frames[0].wi/2, y+Asset.luoi_hai.frames[0].hi*0.6f/2-Asset.comment.frames[0].hi/2,score);
