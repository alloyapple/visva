...
public class SkillBut extends IEntityMenu{

	public SkillBut (GameOS game, IScreen screen) {
		super(game, screen);
	...
	public void start () {
		...
		but = game.stageHelper.createButtonLogic(game.X(222), game.Y(490-132), game.X(339-222), game.Y(100), new ChangeListener() {			
			@Override
